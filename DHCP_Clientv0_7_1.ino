...
volatile char message[125]; 				//This is the maximum size message I've been able to push through the zigbee network.
...
void loop() {
  byte temp = 0x0; 				   	//Temp byte storage.
	...
	switch(msgType) {				//Now I know what the message type is. Send the processing to the correct function.
	  ...
	  case 0x90:					//Simple text message to be processed.
...
void processTextMsg() {
  ...
  lenght = lenght - 10; 			   	//Account for the header info we stripped off the message.
